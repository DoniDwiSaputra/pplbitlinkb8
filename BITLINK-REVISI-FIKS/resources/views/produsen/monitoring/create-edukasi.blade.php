                        ...
                        @if (Auth::user()->role == 'AKUN DINAS')
                            <form method="POST" action="{{ url('/monitoring-edukasi/dinas') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" id="tanggal_edukasi" name="tanggal_edukasi" class="form-control"
                                ...
                                <div class="d-flex justify-content-between mt-5">
                                    <a href="{{ url('/monitoring-edukasi') }}">
                                        <button type="button" style="border: 1px solid #7A5CFA"
